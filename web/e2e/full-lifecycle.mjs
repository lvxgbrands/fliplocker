...
await sp.fill('input[name="cardYear"]', "1989");
await sp.fill('input[name="playerName"]', "Ken Griffey Jr.");
await sp.selectOption('select[name="gradingCompany"]', "PSA");
await sp.fill('input[name="certNumber"]', "24810881");
  await sp.fill('input[name="grade"]', "PSA 8");
await sp.fill('input[name="salePrice"]', "425");
